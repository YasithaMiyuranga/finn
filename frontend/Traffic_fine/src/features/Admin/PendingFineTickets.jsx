        ...
        <div className="min-h-screen flex bg-gray-100" style={{ fontFamily: "'Segoe UI', Roboto, sans-serif" }}>
            ...
            <aside style={{
                ...
                {navItems.map(item => (
                    <button key={item.id} onClick={() => handleNav(item.id)} title={item.label} style={{
                        ...
                        color: item.id === 'pending-fine-tickets' ? '#ffffff' : 'rgba(255,255,255,0.6)',
                        backgroundColor: item.id === 'pending-fine-tickets' ? '#1a7a7a' : 'transparent',
                        ...
                        {sidebarOpen && (
                            <span style={{ fontSize: '14px', fontWeight: '500', color: item.id === 'pending-fine-tickets' ? '#fff' : 'rgba(255,255,255,0.8)' }}>
                                {item.label}
                            </span>
                        )}
                    </button>
            ...
            <div style={{ marginLeft: sidebarWidth, flex: 1, display: 'flex', flexDirection: 'column', transition: 'margin-left 0.25s ease' }}>
                ...
                <div style={{ padding: '24px' }}>
                    ...
                    {/* Title + Breadcrumb */}
                    <h1 style={{ fontSize: '28px', fontWeight: '400', color: '#1e293b', marginBottom: '6px' }}>Pending Fine Tickets</h1>
                    ...
                    <div style={{ backgroundColor: 'white', borderRadius: '10px', boxShadow: '0 2px 10px rgba(0,0,0,0.07)', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
                                <thead>
                                    <tr style={{ backgroundColor: '#e9ecef', color: '#212529' }}>
                                ...
                                <tbody>
                                    {filteredTickets.length > 0 ? filteredTickets.map((v, idx) => (
                                        <tr key={idx} style={{ backgroundColor: idx % 2 === 0 ? '#fff' : '#f8f9fa', borderBottom: '1px solid #dee2e6' }}>
                                            ...
                                            <td style={{ padding: '10px 16px', color: '#212529' }}>{v.licenseId}</td>
                                            <td style={{ padding: '10px 16px', color: '#212529' }}>{v.policeId}</td>
                                            <td style={{ padding: '10px 16px', color: '#212529' }}>{v.totalAmount}</td>
                                        </tr>
                                    )) : (
                                        <tr>
                        ...
                        <div style={{ padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #f1f5f9', fontSize: '14px', color: '#212529' }}>
                            ...
                            <div style={{ display: 'flex' }}>
                                ...
                                <button style={{ border: '1px solid #dee2e6', backgroundColor: '#fff', padding: '6px 12px', cursor: 'not-allowed', color: '#0d6efd', marginLeft: '-1px', borderTopRightRadius: '0.25rem', borderBottomRightRadius: '0.25rem' }}>Next</button>
                            </div>
                        </div>
                    </div>

...
import {
    ...
    Edit, Bell, Info, Pencil, Trash2, Search, X, CheckSquare, Pause, ShieldCheck,
    TrendingUp, FileText, DollarSign, Activity, BarChart3
} from 'lucide-react';
    ...
    const handlePrint = () => {
        ...
        const content = `
            <html>
                ...
                <body>
                    <div class="header">
                        <h1>View All Drivers | Motor Traffic Department</h1>
                    </div>
                    <table>
                        <thead>
                            <tr>
                                        ...
                                        <tr key={idx} style={{ backgroundColor: idx % 2 === 0 ? '#fff' : '#f8f9fa', borderBottom: '1px solid #dee2e6' }}>
                                            <td style={{ padding: '10px 16px' }}>
                                                <div style={{ display: 'flex', gap: '6px' }}>
                                                    ...
                                                    <button onClick={() => handleViewStats(driver)}
                                                        style={{ backgroundColor: '#4d2c80', color: 'white', border: 'none', borderRadius: '4px', padding: '4px 8px', cursor: 'pointer' }}
                                                        title="View Fine Statistics">
                                                        <BarChart3 size={14} />
                                                    </button>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                        ...
                                        <div style={{ backgroundColor: '#fef2f2', padding: '16px', borderRadius: '12px', border: '1px solid #fee2e2' }}>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                                                ...
                                                <div style={{ textAlign: 'right' }}>
                                                    <div style={{ fontSize: '18px', fontWeight: '700', color: '#b91c1c' }}>Rs. {parseFloat(driverStats.pendingFineAmount).toLocaleString()}</div>
                                                    <div style={{ fontSize: '11px', color: '#991b1b' }}>Total Amount</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style={{ backgroundColor: '#ecfdf5', padding: '16px', borderRadius: '12px', border: '1px solid #d1fae5' }}>
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                                                ...
                                                <div style={{ textAlign: 'right' }}>
                                                    <div style={{ fontSize: '18px', fontWeight: '700', color: '#047857' }}>Rs. {parseFloat(driverStats.paidFineAmount).toLocaleString()}</div>
                                                    <div style={{ fontSize: '11px', color: '#065f46' }}>Total Amount</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ backgroundColor: '#f0f9ff', padding: '16px', borderRadius: '12px', border: '1px solid #e0f2fe', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            ...
                                            <div>
                                                ...
                                                <div style={{ fontSize: '11px', color: '#0369a1' }}>Lifetime records in eTRAFFIC</div>
                                            </div>
                                        </div>
                                        <div style={{ textAlign: 'right' }}>
                                            <div style={{ fontSize: '28px', fontWeight: '900', color: '#0369a1', lineHeight: '1' }}>{driverStats.totalFineTicketsCount}</div>
                                            <div style={{ fontSize: '12px', fontWeight: '700', color: '#0369a1', marginTop: '4px' }}>Rs. {parseFloat(driverStats.totalFineTicketsAmount).toLocaleString()}</div>
                                        </div>
                                    </div>

                                    {/* Info Note */}
                                    <p style={{ margin: 0, fontSize: '12px', color: '#64748b', fontStyle: 'italic', textAlign: 'center' }}>
                                        * This data is calculated based on the official records registered under license ID: {selectedDriver.licenseNumber}
                                    </p>
                                </div>
                            )}
                        </div>
